...
const Gallery4 = ({
  ...
  // --- tiny, robust locale detection (no dependency on app hooks)
  ...
  // final label (prop wins; else auto)
      ...
      <div className="container mx-auto">
        <div className="mb-8 flex items-end justify-between md:mb-14 lg:mb-16">
          <div className="flex flex-col gap-4">
            <h2
              className="text-2xl md:text-2xl lg:text-2xl text-[#000000]"
              style={{ fontFamily: "'Work Sans', sans-serif", fontWeight: 400 }}
            >
              {title}
            </h2>
            <p
              className="max-w-lg text-base text-[#000000]"
